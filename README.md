...
The main objective of the game is to help players understand theoretical concepts from each subject through animations and interactive challenges. Additionally, the game encourages strategic thinking by requiring players to manage resources such as food and ship condition.
Each food item provides a limited saturation time; if the pirate does not eat again before this time expires, the level is considered lost and the player’s progress is reset, adding an element of survival and responsibility to the learning process.
This project combines education, strategy, and adventure, offering an engaging way to learn while reinforcing discipline, decision-making, and subject comprehension.
